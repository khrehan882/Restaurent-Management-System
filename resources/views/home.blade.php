            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <!-- ***** Logo End ***** -->
                        <!-- ***** Menu Start ***** -->
                        <ul style="right: 20px" class="nav">
                            <li class="scroll-to-section"><a href="#top" class="active"><i class="fas fa-home"></i>
                                    Home</a></li>
                        ...
                        -->
                            ...
                            <li class="scroll-to-section">
                                <a href="{{url('/showcart', Auth::user()->id)}}">
                                    ...
                                    @auth
                                    {{-- Cart{{$count}} Bad me laazmi checkout krna --}}
                                    @endauth
                                    @guest
                                        cart[0]
                                    @endguest
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="logo">
                        <a href="{{ url('/') }}" class="logo">
                            <img src="assets/images/white-logo.png" alt="Klassy Cafe HTML Template">
                        </a>
                    </div>
                </div>
                <div class="col-lg-4 col-xs-12">
